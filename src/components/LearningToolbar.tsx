...
import { LEARNABLE_ITEMS, LEARNABLE_CHORD_PROGRESSIONS, type LearnableItem, type LearnableChordProgression, type SelectableItem } from "@/lib/music-theory";
        ...
        <>
            <div className="relative group">
                <Button
                    variant="outline"
                    size="icon"
                    className="h-12 w-12 rounded-full border-orange-500/30 bg-purple-900/50 hover:bg-purple-800/70 text-orange-200 hover:text-orange-100 backdrop-blur-md"
