...
export function ChordDisplay({ chordInfo, isMidiPlayerActive }: ChordDisplayProps) {
  ...
  return (
    <div className={cn(
      "absolute z-30 flex flex-col items-center gap-2 transition-all duration-300 ease-in-out",
      isMidiPlayerActive 
      ...
      >
        {chordInfo.notes.map((note, index) => (
          <div key={index} className="flex items-center gap-2">
            <div className="flex h-10 w-10 items-center justify-center rounded-md bg-black/40 shadow-inner backdrop-blur-sm">
